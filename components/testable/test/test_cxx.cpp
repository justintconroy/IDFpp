...
// TEST_CASE("std::out_of_range exception when -fno-exceptions", "[cxx][reset=abort,SW_CPU_RESET][fails]")
// {
//     std::vector<int> v(10);
//     v.at(20) = 42;
...
// TEST_CASE("std::bad_alloc exception when -fno-exceptions", "[cxx][reset=abort,SW_CPU_RESET][fails]")
// {
